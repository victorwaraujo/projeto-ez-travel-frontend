...
export function ConfirmTripModal ({
    ...
    setOwnerName,
    setOwnerEmail,
    evenStartAndEndDates,
    destination,
}: ConfirmTripModalProps) {
  const displayedDate = evenStartAndEndDates && evenStartAndEndDates.from && evenStartAndEndDates.to
  ? format(evenStartAndEndDates.from, "d' de 'LLLL' de 'yyyy", { locale: ptBR }).concat(' até ').concat(format(evenStartAndEndDates.to, "d' de 'LLLL' de 'yyyy", { locale: ptBR }))
  : null
